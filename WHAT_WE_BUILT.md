...
84 fixture variants across 19 scenarios. Each fixture contains visual config + demo data that the widget can render standalone.

### All 19 Widgets (F8 Fix: corrected from 23)
  ...
  frontend/
    src/
      ...
      components/
        ...
        layer4/
          widgetRegistry.ts       19 widgets, lazy-loaded
          fixtureData.ts          84 fixture variants
          widgets/*.tsx            19 widget components
